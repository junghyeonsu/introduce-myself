    ...
    <div>
      ...
      <ContactItem>
        <FiberManualRecordIcon
          style={{ fontSize: "1.5vw", color: "#2d81ff" }}
        />
        <span>티스토리 블로그 (개인 공부) :</span>
        <a href="https://junghyeonsu.tistory.com/" target="_blank">
          https://junghyeonsu.tistory.com/
        </a>
      </ContactItem>
      <ContactItem>
        <FiberManualRecordIcon
